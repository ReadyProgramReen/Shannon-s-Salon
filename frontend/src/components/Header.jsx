...
const Header = () => {
  return (
    <div className='mx-[80px] flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
        {/* left side  */}
        <div className=' md:w-1/2 flex flex-col items-start justify-center gap-5 py-10 m-auto md:py-[10vw] md:mb-[-30px]' >
            ...
            <a href="#speciality" className='flex items-center gap-2 bg-[#eec4ae]  px-6 py-3 rounded-full text-yellow-500 text-,d font-medium md:m-0 hover:scale-105 hover:font-semibold transition-all duration-300'>Book Appointment <img className='mt-1' src={arrow_icon} alt="" /></a>
